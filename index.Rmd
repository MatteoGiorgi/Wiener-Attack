...
Now that we have found a possible value for the Euler function $\phi$, we won: the two prime factors of the RSA module have to be $60317$ and $40577$ ✌️. Was it too quick? Take a look at the paper below, it will satisfy any doubts and [show you some code](https://lkml.org/lkml/2000/8/25/132) in Wolfram Mathematica.

<p align="center">
  <embed src="src/wiener_attack.pdf" type="application/pdf" width="100%" height="600px"/>
</p>
