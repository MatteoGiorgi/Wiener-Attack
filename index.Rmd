...
Now that we have found a possible value for the Euler function $\phi$, we won ✌️🥳. The two prime factors of the RSA module has to be $60317$ and $40577$! Was it too quick? Take a look at the paper below, it will satisfy any doubts together with some code in Wolfram Mathematica 🤓.
